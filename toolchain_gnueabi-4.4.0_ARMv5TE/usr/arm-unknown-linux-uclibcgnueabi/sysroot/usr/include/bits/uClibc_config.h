...
#define __KERNEL_HEADERS__ "/usr/src/arm-linux-3.3/buildroot-2012.02/output/toolchain/linux/include"
...
#define __CROSS_COMPILER_PREFIX__ "/usr/src/arm-linux-3.3/toolchain_gnueabi-4.4.0_ARMv5TE/usr/bin/arm-unknown-linux-uclibcgnueabi-"
